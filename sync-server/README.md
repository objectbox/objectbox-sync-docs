...
{% hint style="info" %}
**Where to find the data model file?** Depending on the ObjectBox API, the file is often called `objectbox-model.json` and is located close to your source code. Special hints:
