---
title: "Object IDs and Sync - ObjectBox C++"
description: "ObjectBox Sync offers local and global ID spaces. Understand the implications and what's best for your use case."
keywords:
  - objectbox
  - c++
  - cpp
...
<TechnicalArticleSchema
  headline="Object IDs and Sync - ObjectBox C++"
  description="ObjectBox Sync offers local and global ID spaces. Understand the implications and what's best for your use case."
  url="https://cpp.objectbox.io/object-ids"
