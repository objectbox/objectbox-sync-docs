---
title: "MongoDB Data Mapping - ObjectBox C++"
description: "Ensure smooth data synchronization between MongoDB and ObjectBox by correctly mapping data and types."
keywords:
  - objectbox
  - c++
  - cpp
...
<TechnicalArticleSchema
  headline="MongoDB Data Mapping - ObjectBox C++"
  description="Ensure smooth data synchronization between MongoDB and ObjectBox by correctly mapping data and types."
  url="https://cpp.objectbox.io/mongodb-data-mapping"
...
![Comparison of ObjectBox Object and MongoDB Document structure](/img/assets/ObjectVsDocument (1).png)
...
<table><thead><tr><th width="198.5333251953125">MongoDB type</th><th width="216.6998291015625" align="center">Incoming from MongoDB</th><th align="center">IDs for new documents created in ObjectBox</th></tr></thead><tbody><tr><td>Object ID</td><td align="center">✅</td><td align="center">✅<br/>>This is the default type</td></tr><tr><td>UUID (Binary with UUID subtype)</td><td align="center">✅</td><td align="center">✅<br/>>External types: Uuid (V7) or UuidV4</td></tr><tr><td>String</td><td align="center">✅</td><td align="center">✅<br/>>External types: UuidString (V7) or UuidV4String</td></tr><tr><td>Binary</td><td align="center">✅</td><td align="center">Uses default MongoDB Object ID</td></tr><tr><td>Int64</td><td align="center">✅</td><td align="center">Uses default MongoDB Object ID</td></tr><tr><td>Int32</td><td align="center">✅</td><td align="center">Uses default MongoDB Object ID</td></tr></tbody></table>
...
![To-One Relationship Example: motherId mapping](/img/assets/ObjectVsDocument-Parent (1).png)
