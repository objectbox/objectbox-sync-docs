---
title: "ObjectBox Sync Server Updates: Public Docker Images and E..."
...
<TechnicalArticleSchema
  headline="ObjectBox Sync Server Updates: Public Docker Images and E..."
  description="Latest updates to ObjectBox Sync Server include public Docker images, enhanced MongoDB data mapping, improved JWT authentication, and admin UI fixes."
  url="https://cpp.objectbox.io/2025-06-02-blog-post"
...
Latest updates to ObjectBox Sync Server include public Docker images, enhanced MongoDB data mapping, improved JWT authentication, and admin UI fixes.
...
- [Sync Server Configuration](sync-server/configuration)